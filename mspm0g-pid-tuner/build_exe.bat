...
pyinstaller --onefile --windowed --name mspm0g-pid-tuner --add-data "config.example.json;." --hidden-import serial --hidden-import serial.tools.list_ports --hidden-import openai --hidden-import queue mspm0g_tuner/gui.py
if %ERRORLEVEL% EQU 0 (
    echo.
